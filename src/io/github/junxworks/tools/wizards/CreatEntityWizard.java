...
public class CreatEntityWizard extends Wizard implements INewWizard {
	private EntityConfWizardPage page;
	private ISelection selection;

	public CreatEntityWizard() {
		super();
		setNeedsProgressMonitor(true);
	}
	
	public void addPages() {
		page = new EntityConfWizardPage(selection);
		addPage(page);
	}
