...
public class CreatObjectWizard extends Wizard implements INewWizard {
	private CreateObjectPage page;
	private ISelection selection;

	public CreatObjectWizard() {
		super();
		setNeedsProgressMonitor(true);
	}

	public void addPages() {
		page = new CreateObjectPage(selection);
		addPage(page);
	}

	public boolean performFinish() {
		EntityModel entity = new EntityModel();
		if (!page.extractData(entity))
			return false;
